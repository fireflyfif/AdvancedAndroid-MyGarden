...
public class PlantWateringService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        if (intent != null) {
            ...
            if (ACTION_WATER_PLANT.equals(action)) {
                // COMPLETED: Call putExtra and passing the plantId when creating the pending intent
                // for the watering service
    ...
    private void handleActionUpdatePlantWidgets() {
        ...
        // COMPLETED: Add a new boolean parameter to updatePlantWidgets to indicate if the plant
        // can be watered or not
        ...
        if (cursor != null && cursor.getCount() > 0) {
            ...
            int indexId = cursor.getColumnIndex(PlantContract.PlantEntry._ID);
