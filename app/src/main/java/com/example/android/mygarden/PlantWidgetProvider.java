...
public class PlantWidgetProvider extends AppWidgetProvider {
    ...
    private static RemoteViews getGardenGridRemoteView(Context context) {
        ...
        // COMPLETED: Create a RemoteView object with the GridView layout;
        // Connect it with the RemoteViewService that will bind the remote views with the Adapter's cursor data
     ...
     * @return The RemoteViews for the single plat mode widget
     */
